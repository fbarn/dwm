...
static int previouslayout    = -1;   /* NULL means no previous layout */
...
//	{ MODKEY,                       XK_f,      setlayout,      {.v = &layouts[1]} },
    ...
    { MODKEY|ControlMask,           XK_k,      moveplace,      {.ui = WIN_N  }},
    { MODKEY|ControlMask,           XK_j,      moveplace,      {.ui = WIN_S  }},
    { MODKEY|ControlMask,           XK_l,      moveplace,      {.ui = WIN_E  }},
    { MODKEY|ControlMask,           XK_h,      moveplace,      {.ui = WIN_W  }},
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
